      ...
      <div className="bg-slate-900 rounded-xl p-6 max-w-lg w-full shadow-lg border border-slate-800">
        ...
        <div className="flex space-x-4 justify-end">
          ...
          <button
            ...
            className={`${parsedIdol ? "bg-indigo-600 hover:bg-indigo-500" : "bg-slate-700 cursor-not-allowed"} py-2.5 px-4 rounded-lg text-sm font-medium shadow-sm transition-colors`}
            disabled={!parsedIdol}
          >
            Add to Inventory
          </button>
