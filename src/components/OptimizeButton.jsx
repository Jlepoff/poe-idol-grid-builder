...
function OptimizeButton({ onOptimize }) {
  ...
  function getReasonText(reason) {
    switch(reason) {
      case 'no_space': return 'No suitable space';
      case 'size_too_large': return 'Too large for remaining space';
      case 'overlapping': return 'Would overlap other idols';
      case 'blocked_cells': return 'Would cover blocked cells';
      default: return 'Could not fit in grid';
    }
  }
